...
Este bloco compara os nomes de famílias, gêneros e espécies associados aos registros no banco de dados com a lista de nomes registrados em duas bases de dados: o [Reflora](https://ipt.jbrj.gov.br/jbrj/resource?r=lista_especies_flora_brasil) e o [World Checklist of Vascular Plants](https://sftp.kew.org/pub/data-repositories/WCVP/). O Reflora foca na taxonomia das espécies que ocorrem no Brasil, e é uma referência nacional. Não obstante, táxons de outras partes do mundo raramente constam nos registros deles. Isso faz com que esses nomes sejam contados junto com os nomes incorretos neste teste. O World Checklist of Vascular Plants, mantido pelo Kew Royal Botannical Gardens tem uma lista mais abrangente, de modo que optei por testar os nomes registrados nas duas bases de dados.
