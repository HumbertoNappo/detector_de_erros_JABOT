...
Este script contém cinco testes que buscam inconsistência no hábito registrado. Este primeiro talvez torne os outros obsoletos na maioria dos casos, mas optei por deixar todos aqui por acreditar que ainda podem ser úteis na triagem dos erros. Este primeiro teste compara os hábitos registrados no Jabot e no Flora e Funga do Brasil e retorna as linhas com incongruência. Letras minúsculas e maiúsculas são consideradas iguais para essa comparação, mas outras difereças de grafia são tratadas como hábitos diferentes.
